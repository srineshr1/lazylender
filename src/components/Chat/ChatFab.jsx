...
export default function ChatFab({ onOpen, className = '' }) {
  return (
    <div className={`fixed bottom-6 right-6 z-40 ${className}`}>
      <button
        onClick={() => onOpen()}
        className="w-12 h-12 rounded-full bg-accent shadow-lg hover:bg-accent/90 hover:shadow-xl hover:scale-105 active:scale-95 transition-all flex items-center justify-center"
